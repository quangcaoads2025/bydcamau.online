...
(function () {
      ...
      <div class="topbar" aria-label="Thông tin nhanh">
        <div class="container topbar__inner">
          <div class="topbar__group topbar__group--left">
            <a href="index.html#contact" class="topbar__item">${icon('map')}<span>${showroom.address}</span></a>
  ...
  function renderHeader(activePage = 'home') {
    ...
    const vehicleItems = menuVehicles.map(vehicle => `
      <a class="mega-menu__vehicle" href="vehicle.html?slug=${vehicle.slug}">
    ...
    return `
      ...
      <header class="site-header" id="site-header">
        <div class="container header__inner">
          <a class="brand" href="index.html" aria-label="BYD Thành Công Cà Mau - Trang chủ">
            <img src="assets/images/logo-byd-thanh-cong.webp" alt="Logo BYD Thành Công Cà Mau" width="250" height="103">
          </a>
          <nav class="main-nav" aria-label="Điều hướng chính">
            <a class="nav-link ${activePage === 'home' ? 'is-active' : ''}" href="index.html">Trang chủ</a>
            ...
            <div class="nav-item nav-item--mega">
              ...
              <div class="mega-menu" role="menu">
                <div class="mega-menu__head">
                  ...
                  <a href="index.html#vehicles" class="text-link">Xem tất cả ${icon('chevronRight')}</a>
                </div>
                <div class="mega-menu__grid">${vehicleItems}</div>
              </div>
            </div>
            <a class="nav-link" href="index.html#offers">Khuyến mãi</a>
            <a class="nav-link ${activePage === 'news' ? 'is-active' : ''}" href="index.html#news">Tin tức</a>
            <a class="nav-link ${activePage === 'charging' ? 'is-active' : ''}" href="charging.html">Trạm sạc</a>
        ...
        <div class="mobile-menu" aria-hidden="true" role="dialog" aria-modal="true" aria-label="Menu điều hướng">
          <div class="mobile-menu__head">
            <a class="mobile-menu__brand" href="index.html" aria-label="BYD Thành Công Cà Mau - Trang chủ">
              <img src="assets/images/logo-byd-thanh-cong.webp" alt="BYD Thành Công Cà Mau" width="182" height="75">
            </a>
          ...
          <details>
            ...
            <div class="mobile-menu__vehicles">${menuVehicles.map(v => `<a href="vehicle.html?slug=${v.slug}">${v.name}</a>`).join('')}</div>
          </details>
          <a href="index.html#offers">Khuyến mãi</a>
          <a href="index.html#news">Tin tức</a>
          <a href="charging.html">Trạm sạc</a>
    ...
    return `
      <article class="vehicle-card" data-segment="${vehicle.segment.toLowerCase()}" data-powertrain="${vehicle.powertrain.toLowerCase()}">
        <div class="vehicle-card__visual">
          ...
          <a href="vehicle.html?slug=${vehicle.slug}" aria-label="Xem chi tiết ${vehicle.name}">${vehicleImage(vehicle, 'vehicle-card__image')}</a>
        </div>
        <div class="vehicle-card__body">
          <p class="vehicle-card__type">${vehicle.segment} · ${vehicle.powertrain === 'EV' ? 'Thuần điện' : 'Super Hybrid'}</p>
          <h3><a href="vehicle.html?slug=${vehicle.slug}">${vehicle.name}</a></h3>
          <p class="vehicle-card__price">${vehicle.priceLabel}</p>
          <ul class="vehicle-card__specs">${specs}</ul>
          <div class="vehicle-card__actions">
            <a class="button button--outline button--small" href="vehicle.html?slug=${vehicle.slug}">Xem chi tiết</a>
      ...
      <footer class="footer">
        <div class="container footer__grid">
          <div class="footer__brand">
            <img src="assets/images/logo-byd-thanh-cong.webp" alt="BYD Thành Công Cà Mau" width="250" height="103">
          ...
          <div>
            ...
            <ul class="footer__links">
              <li><a href="index.html#vehicles">Dòng xe</a></li>
              <li><a href="index.html#offers">Khuyến mãi</a></li>
              <li><a href="index.html#showroom">Showroom</a></li>
              <li><a href="charging.html">Trạm sạc</a></li>
        ...
        <div class="footer__bottom">
          <div class="container footer__bottom-inner">
            ...
            <div class="footer__legal"><a href="privacy.html">Chính sách bảo mật</a><a href="terms.html">Điều khoản sử dụng</a></div>
          </div>
        </div>
      </footer>`;
  }
  ...
  function renderFloatingContact() {
    return `
      <div class="floating-contact" aria-label="Liên hệ nhanh">
        <a href="tel:${CONFIG.hotlineSales}" class="contact-fab contact-fab--phone" aria-label="Gọi điện">
        ...
        <div class="floating-contact__bottom-row">
          <button type="button" class="mobile-register-cta" data-open-modal="lead" data-intent="Đăng ký tư vấn" aria-label="Đăng ký ngay để được tư vấn miễn phí">
            <span class="mobile-register-cta__icon">${icon('document')}</span>
            <span class="mobile-register-cta__copy"><strong>Đăng ký ngay</strong><small>Tư vấn miễn phí</small></span>
            <span class="mobile-register-cta__arrow">${icon('chevronRight')}</span>
          </button>
        ...
        <div class="modal__dialog modal__dialog--form">
          ...
          <aside class="modal__intro">
            <div class="lead-modal__brandline">
              <span class="eyebrow">BYD Thành Công Cà Mau</span>
              <span class="lead-modal__status"><i aria-hidden="true"></i> Đang tiếp nhận</span>
            </div>
            <div class="lead-modal__art" aria-hidden="true">
              <span class="lead-modal__orbit lead-modal__orbit--one"></span>
              <span class="lead-modal__orbit lead-modal__orbit--two"></span>
              <span class="lead-modal__carline">BYD</span>
            </div>
          ...
          <form class="lead-form" id="modal-lead-form" novalidate>
            ...
            <div class="lead-modal__privacy-note">${icon('shield')}<span>Dữ liệu được xử lý theo <a href="privacy.html" target="_blank">Chính sách bảo mật</a>. Bạn có thể yêu cầu cập nhật hoặc xóa thông tin liên hệ.</span></div>
