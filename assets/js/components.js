...
(function () {
  ...
  function vehicleImage(vehicle, className = '') {
    ...
    const loading = 'lazy';
    const priority = '';
    const source = vehicle.cardRemote || vehicle.image; const small = source.replace(/card\.webp(?:\?.*)?$/, 'card-480.webp'); return `<img class="${className}" src="${small}" srcset="${small} 480w, ${source} 768w" sizes="${isCatalogCard ? '(max-width: 760px) calc(100vw - 28px), (max-width: 1024px) 50vw, 390px' : '180px'}" data-fallback="${vehicle.image}" alt="${vehicle.name} tại BYD Thành Công Cà Mau" width="768" height="432" loading="${loading}" decoding="async"${priority}>`;
  }
      ...
      <header class="site-header" id="site-header">
        <div class="container header__inner">
          <a class="brand" href="/" aria-label="BYD Thành Công Cà Mau - Trang chủ">
            <img src="assets/images/logo-byd-thanh-cong.webp" alt="Logo BYD Thành Công Cà Mau" width="520" height="202">
          </a>
        ...
        <div class="mobile-menu" aria-hidden="true" role="dialog" aria-modal="true" aria-label="Menu điều hướng">
          <div class="mobile-menu__head">
            <a class="mobile-menu__brand" href="/" aria-label="BYD Thành Công Cà Mau - Trang chủ">
              <img src="assets/images/logo-byd-thanh-cong.webp" alt="BYD Thành Công Cà Mau" width="520" height="202">
            </a>
