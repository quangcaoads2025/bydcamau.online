...
for (const file of htmlFiles) {
  ...
  while ((match = scriptPattern.exec(html))) {
    ...
    // JSON-LD is a non-executable data block, so it does not need script execution permission.
...
// Hash every local JavaScript file. Matching SRI attributes are added by add-script-integrity.mjs.
const jsFiles = [];
